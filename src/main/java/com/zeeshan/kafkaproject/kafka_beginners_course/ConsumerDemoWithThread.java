package com.zeeshan.kafkaproject.kafka_beginners_course;
...
public class ConsumerDemoWithThread {
	...
	private void run() {
		...
		final Runnable myConsumerRunnable = new ConsumerThread(latch, bootstrapServers, groupId, topic);
		//new ConsumerThread(topic, bootstrapServers, groupId, latch);
		// start the thread
